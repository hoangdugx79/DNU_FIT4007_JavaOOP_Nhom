...
- [Dataset mẫu](#dataset-mẫu)
- [Test Cases cốt lõi](#test-cases-cốt-lõi)
- [Thiết kế OOP](#thiết-kế-oop)
- [Lưu ý quan trọng](#lưu-ý-quan-trọng)
- [Phân công (3 thành viên)](#phân-công-3-thành-viên)
- [Tác giả](#tác-giả)
- 
## Yêu cầu hệ thống
...
- **iText PDF:** Version 5.5.13 (để xuất báo cáo PDF)
    - Download: [iText 5.5.13](https://repo1.maven.org/maven2/com/itextpdf/itextpdf/5.5.13/)
...
│   │   └── Searchable.java
│   │
│   ├── repository/                      # 4 files - Data Access Layer
...
│   │   └── ReportService.java
│   │
│   ├── ui/                              # 1 file - Console Interface
│   │   └── ConsoleMenu.java
│   │
│   └── Main.java                        # Entry point
│
├── data/                                # 6 CSV files - Data Storage
│   ├── products.csv
│   ├── customers.csv
│   ├── suppliers.csv
│   ├── import_orders.csv
...
│   └── (các file báo cáo sẽ được tạo ở đây)
│
|── lib/
│   ├── itextpdf-5.5.13.jar
...
**IntelliJ IDEA:**
1. Nhấn chuột phải project → **Open Module Settings** (F4)
2. **Libraries** → **+** → **Java** → Chọn `lib/itextpdf-5.5.13.jar`
3. **OK** và **Apply**

**Eclipse:**
1. Nhấn chuột phải project → **Build Path** → **Configure Build Path**
2. **Libraries** → **Add External JARs** → Chọn `lib/itextpdf-5.5.13.jar`
3. **Apply and Close**

### Bước 2: Chạy ứng dụng

1. Mở file `Main.java`
2. Nhấn chuột phải → **Run 'Main.Main()'**
